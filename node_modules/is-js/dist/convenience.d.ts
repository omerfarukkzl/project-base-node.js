 ...
 */
export declare function empty(value: Array<any>): value is [];
export declare function empty(value: {
 ...
 */
export declare function nonNil<T>(value: T | null | undefined): value is T;
